export const skills = {
  ...
  { name: "Next.js", level: 85, years: 2 },
    ...
    { name: "WSL (Ubuntu)", level: 70, years: 1 },
    { name: "VS Code", level: 90, years: 3 },
    { name: "Postman", level: 80, years: 2 },
    { name: "NPM", level: 80, years: 2 },
    { name: "Apache Airflow", level: 70, years: 1 },
    { name: "dbt", level: 70, years: 1 },
    { name: "Supabase", level: 70, years: 1 },
    { name: "Snowflake", level: 70, years: 1 },
    { name: "Looker Studio", level: 70, years: 1 },
    { name: "Pandas", level: 75, years: 2 },
  ],
};
